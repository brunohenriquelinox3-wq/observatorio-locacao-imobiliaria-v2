...
| **Vendas e contratos** | Ligação entre estoque de lote, cliente(s), proposta, reserva, venda e novo contrato; lente de contratos realizados por lote. | Um lote só avança se estiver elegível; contrato preserva versão de tabela, partes, condição, evidência e alçada. A seleção de Cliente Loteadora reutiliza ficha/dossiê elegíveis e registra snapshot contratual sem reescrever o passado. |
