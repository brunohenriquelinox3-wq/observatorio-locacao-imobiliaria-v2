...
| ENG-17 | Tratar o diff como unidade de auditoria | Classificação C0–C4 por superfície, efeito e reversibilidade; tipo/lint/segredo/teste no editor/commit, e PR com requisito, risco e owner. | Fundação bloqueadora | Nenhum merge protegido ocorre sem checks obrigatórios, revisão de escopo e exceção datada/compensada quando um gate não passa. |
...
| ENG-19 | Governar promoção por sinal e orçamento de erro | Release/correlação, SLO por jornada, alerta acionável, freeze proporcional, rollback e retomada por evidência. | Fundação | Falha recorrente/material reduz a permissão de mudança da superfície até repro, regressão, runbook e decisão de retomada. |
