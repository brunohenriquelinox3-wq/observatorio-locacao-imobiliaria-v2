...
| Parceiro acompanha seu negócio. | Portal mínimo de leitura e solicitação, mostrando ganhos realizados/projeções, contratos, lotes e carteira no escopo autorizado. | Não permite baixar cobrança, alterar lote, regra, contrato, carteira, alçada ou acesso administrativo. |
...
O painel de parceiro é uma superfície de transparência controlada: ele pode mostrar contratos e lotes que compõem o vínculo individual ou grupo contratado, bem como clientes adimplentes/inadimplentes cuja carteira gera o direito econômico autorizado. A informação aparece com finalidade, escopo e estado explícitos; dados de clientes e de outros recebedores fora do vínculo permanecem restritos. Assim, a loteadora permite que o parceiro acompanhe o impacto de atraso e as projeções sem abrir a carteira integral da empresa. [37]
