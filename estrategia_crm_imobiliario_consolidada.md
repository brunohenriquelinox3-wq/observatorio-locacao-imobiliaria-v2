...
| **LOTEADORA** | Cadastro de Loteamentos; Estoque/Mapa de Lotes; sócios/parceiros/fazendeiros; clientes; vendas/contratos; financeiro, boletos, carteira e busca protegida. | Cadastro cria a estrutura de gleba, empreendimento, fase, quadra e lote; cada quadra é matriz dos lotes (`Q12 · L1` até `Q12 · L100`). Estoque/Mapa opera os lotes criados. Registro, restrição, alocação, reserva, contrato, tabela e alçada definem elegibilidade; boleto é instrução, não caixa confirmado. |
