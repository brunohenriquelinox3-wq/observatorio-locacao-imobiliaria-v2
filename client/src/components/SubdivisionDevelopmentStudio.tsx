          ...
          <section className="subdivision-studio__active-module" aria-labelledby={`studio-module-${activeModule}`}>
            ...
            {activeModule === "structure" && <div className="subdivision-studio__structure-module">
              ...
              {selectedDevelopmentId && physicalLots.length > 0 && <section className="subdivision-lot-management" aria-labelledby="lot-management-title">
                <div className="subdivision-lot-management__head"><div><span>GESTÃO FÍSICA POR UNIDADE</span><h5 id="lot-management-title">Matriz detalhada por Quadra e Lote.</h5><p>Use os filtros para localizar um Lote. Ao apontar ou focar uma unidade, a referência por m² e o valor total aparecem somente após política aprovada e vigente; venda, contrato e financeiro permanecem em setores próprios.</p></div><div className="subdivision-lot-management__head-mark"><Ruler size={20} /><span>Leitura física</span></div></div>
