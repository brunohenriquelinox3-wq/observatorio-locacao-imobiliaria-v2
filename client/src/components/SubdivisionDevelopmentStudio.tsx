...
export function SubdivisionDevelopmentStudio({ context, isContextReady, isWorkspaceReady }: DevelopmentStudioProps) {
  ...
  const [operationalLotDraft, setOperationalLotDraft] = useState({ blockId: "", lotNumber: "", areaSqm: "", frontageM: "", depthM: "", lotTypology: "standard" as "standard" | "corner" | "irregular" | "other", positionCode: "not_declared" as "not_declared" | "internal" | "corner" | "end", reservationPurpose: "none" as "none" | "landowner_reserve" | "technical_artesian_well" | "technical_water_tank" | "technical_other", internalNote: "" });
