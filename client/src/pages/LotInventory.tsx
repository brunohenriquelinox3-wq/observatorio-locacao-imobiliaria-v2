...
export default function LotInventory() {
  ...
  return <DashboardLayout navigationItems={crmNavigationItems} navigationTitle="Núcleo CRM" accessGate={accessGate}><main className="lot-inventory-page" onSubmitCapture={handleLotSubmitCapture}>
    ...
    <LotStructureMatrix contextReady={contextReady} blockSelected={Boolean(blockId)} blockLabel={selectedBlock ? draftBlockSelectionLabel(selectedBlock) : undefined} lots={lots.data} inventoryStates={inventoryStates.data} isLoading={lots.isLoading || inventoryStates.isLoading} isError={lots.isError || inventoryStates.isError} />
