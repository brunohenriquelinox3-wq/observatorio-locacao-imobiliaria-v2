...
import { supabasePasswordFlowFromFragment, type SupabasePasswordFlow } from "@/lib/supabaseInvitationActivation";
...
export default function AccountActivation() {
  ...
  const [flow] = useState<SupabasePasswordFlow | null>(() => typeof window === "undefined" ? null : supabasePasswordFlowFromFragment(window.location.hash));
