...
import { ArrowUpRight, Building2, Compass, FileUp, Home, KeyRound, LandPlot, ShieldCheck, UsersRound, Workflow } from "lucide-react";
...
export default function OrganizationAdmin() {
  ...
  return <DashboardLayout navigationItems={navigationItems} navigationTitle="Núcleo CRM" accessGate={accessGate}><main className="organization-admin">
    ...
    <section className="organization-admin__mfa-guide" aria-labelledby="mfa-guide-title"><div className="organization-admin__mfa-icon"><KeyRound size={22} aria-hidden="true" /></div><div className="organization-admin__mfa-copy"><p className="organization-admin__eyebrow">PASSO OBRIGATÓRIO ANTES DE CADASTRAR</p><h2 id="mfa-guide-title">Valide sua segurança antes de criar ou alterar.</h2><p>Para cadastrar loteamentos, alterar Quadras ou preparar acessos, você precisa confirmar o MFA. Isso protege a empresa e não concede novas permissões.</p><ol><li>Clique no botão ao lado.</li><li>Escolha <b>Configurar</b> se for a primeira vez ou <b>Renovar</b> se já usa autenticador.</li><li>Leia e confirme o código no aplicativo autenticador do seu celular.</li><li>Volte a esta tela e retome a tarefa.</li></ol></div><Link href="/seguranca-mfa" className="organization-admin__mfa-action"><span>01 · Segurança</span><b>Configurar ou renovar MFA</b><small>Abre o passo a passo seguro</small><ArrowUpRight size={18} aria-hidden="true" /></Link></section>
