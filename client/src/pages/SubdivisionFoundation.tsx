  ...
  return (
    <DashboardLayout navigationItems={crmNavigationItems} navigationTitle="Núcleo CRM" accessGate={subdivisionAccessGate}>
      <main className="subdivision-foundation-page">
        ...
        <SubdivisionBuyerClientDirectory context={context} isContextReady={isContextReady} isWorkspaceReady={isWorkspaceReady} selectedBuyerClientId={buyerClientIdForProfile} onSelectBuyerClient={selectBuyerClient} />
