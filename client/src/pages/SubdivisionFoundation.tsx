  ...
  return (
    <DashboardLayout navigationItems={crmNavigationItems} navigationTitle="Núcleo CRM" accessGate={subdivisionAccessGate}>
      <main className="subdivision-foundation-page">
        ...
        {activeSector === "finance" && <SubdivisionInternalReceivableBatchPanel isReady={isWorkspaceReady} batches={internalReceivableBatchesQuery.data} isLoading={internalReceivableBatchesQuery.isLoading} isError={internalReceivableBatchesQuery.isError} />}
      </main>
    </DashboardLayout>
  );
}
