...
| **Vendas e contratos** | Proposta, reserva, escolha de lote, tabela, venda, documentação, contrato, pós-venda e visão de contratos realizados por lote. | Estoque elegível + Cliente Loteadora + dossiê/checklist + condição + contrato + carteira. | Reserva deve ser um setor separado ou uma etapa dentro de Vendas? |
