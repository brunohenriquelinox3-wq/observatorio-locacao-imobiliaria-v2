...
- [ ] Conciliar a leitura da Central de Clientes com os vínculos compatíveis existentes para que a busca localize todos os cadastros ativos autorizados e nunca apresente ausência falsa antes de edição ou recadastro.
- [ ] Remover a consulta legada de resumos que retorna acesso negado e que bloqueia indevidamente o editor, fazendo ficha, lista e indicadores dependerem apenas das consultas contextuais autorizadas.
- [ ] Corrigir a inicialização prematura da ponte de sessão para aguardar o token de acesso e reexecutar as consultas de contexto quando ele chegar, evitando que a Central de Clientes permaneça sem contexto após recarga.
