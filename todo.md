...
- [ ] Implementar, testar, validar em desktop e mobile, documentar, sanear e criar checkpoints por marco para a Central de Vendas, sem publicação automática e sem integração bancária ou envio de cobrança até que cada camada esteja expressamente autorizada e pronta.
...
- [ ] Criar e ativar alertas periódicos internos, idempotentes, observáveis, desativáveis e restritos a operadores autorizados. A ativação depende de checkpoint e publicação explícita para que a rotina alcance uma rota de produção; até lá não há mensagem externa, cobrança ou comunicação automática.
