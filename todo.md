...
- [ ] Implementar exclusão controlada, auditada e reversível do cadastro ativo, com confirmação explícita e sem apagar rastreabilidade, para testar a jornada antes do recadastro manual autorizado.
- [ ] Adicionar testes de contrato, contexto, RLS, rejeição, edição, exclusão/restauração, interface e responsividade antes de executar operações sobre a lista privada.
...
- [ ] Corrigir a causa e adicionar testes que provem que a tela não entra em carregamento permanente nem perde seleção após recarga, navegação, edição, arquivamento ou restauração.
