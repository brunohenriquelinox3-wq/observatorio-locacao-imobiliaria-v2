...
- [x] Gerar ZIP/HTML saneados e checkpoints após validação integral, sem alterar Lotes, Quadras, áreas, preços, políticas, condições, reservas, vendas, contratos ou dados financeiros. **A261:** artefatos gerados após build final e verificados quanto a presença, exclusões e saneamento; checkpoint funcional pendente de registro.
