...
- [ ] Corrigir o salvamento da ficha contextual para que o comando emita a mutação protegida, crie ou atualize o perfil correspondente e reflita os campos permitidos no resumo somente após confirmação do servidor.
- [ ] Remover dos novos comandos cadastrais a exigência indevida de MFA recente por operação e alinhá-los à política A276 de sessão AAL2 válida, preservando identidade, contexto, membership, grant, papel, escopo, finalidade, correlação, idempotência e auditoria no servidor.
