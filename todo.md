...
- [x] Publicar o controle contextual de ativação, pausa, retomada e remoção do lembrete diário por identificador seguro. **A301/M7:** o Financeiro da Loteadora passou a concentrar esse controle por organização, sem depender de venda selecionada; a interface preserva o botão de ativação explícita e os controles posteriores de pausa, retomada e remoção. A versão validada será publicada com este checkpoint.
...
- [x] Manter a ordem obrigatória do programa: cadastro/estoque, preparação de negociação, formalização e agenda internos, confirmação comercial do lote, dossiê privado e somente depois lembretes ao operador; não antecipar, fundir ou executar efeitos de etapa posterior. **M6:** o dossiê foi implementado depois da agenda e da confirmação comercial; os lembretes permanecem preparados, mas desativados até a etapa posterior de ativação interna.
