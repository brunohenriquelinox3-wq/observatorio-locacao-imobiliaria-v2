...
- [x] Gerar ZIP/HTML saneados e checkpoints após validação integral, sem migração, alteração de dados físicos, criação de estoque ou mudança comercial. **A268:** ZIP/HTML gerados e verificados quanto a presença, exclusões e saneamento; checkpoint funcional pendente de registro.
