...
- [ ] Avaliar a planilha apenas na fase final de migração controlada; antes de qualquer inserção, exigir autorização material específica, confirmação de contexto e revisão da prévia privada sem dados expostos.
- [ ] Registrar a decisão, validar, gerar ZIP/HTML saneados e salvar checkpoints sem publicação; somente depois considerar cadastro manual, pessoa a pessoa, pela jornada aprovada.
...
- [ ] Cadastrar manualmente os registros privados autorizados, um a um, somente pelos campos de cadastro-base aprovados e no contexto vigente; interromper diante de divergência, duplicidade ou campo fora de escopo.
