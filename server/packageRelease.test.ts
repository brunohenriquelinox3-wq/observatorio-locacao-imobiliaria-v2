...
describe("release package exclusions", () => {
  it("excludes environment, project configuration and historical operational material from source ZIPs", async () => {
    ...
    expect(source).toContain('"todo.md"');
    expect(source).toContain('"crm_infra_supabase_descoberta.md"');
