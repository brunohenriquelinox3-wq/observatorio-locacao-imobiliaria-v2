-- A287: cadastro prático, idempotente e redigido de dados sintéticos autorizados.
...
begin
  ...
  loop
    ...
    if v_buyer_client_id is null then
      select profile.document_reference into v_existing_document_reference
    ...
    if v_existing_lifecycle_state = 'archived' then
