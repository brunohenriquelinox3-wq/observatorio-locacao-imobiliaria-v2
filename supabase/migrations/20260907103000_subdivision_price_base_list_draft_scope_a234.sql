-- A234: corrige somente a verificação de escopo da listagem.
-- Não cria, altera ou remove políticas, linhas de preço-base, condições ou dados comerciais.

drop function if exists public.subdivision_list_price_base_policies_v1(uuid, uuid, public.operating_module, text, uuid);
